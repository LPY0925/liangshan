const IMAGE_SRCS = [
  "../images/zhejiangshenganjixian.png?v=raw",
  "../images/hebeishengsaihanbajixielinchang.png?v=raw",
  "../images/shanxishengyouyuxian.png?v=raw",
  "../images/fujianshengchangtingxian.png?v=raw",
  "../images/guangdongshengdongyuanxian.png?v=raw",
  "../images/shaanxishengliubaxian.png?v=raw",
  "../images/anhuishengjingdexian.png?v=raw",
  "../images/jiangxishengjinganxian.png?v=raw",
  "../images/guizhoushengguiyangshiwudangqu.png?v=raw",
  "../images/sichuanshengjiuzhaigouxian.png?v=raw",
  "../images/jiangsushengsihongxian.png?v=raw",
  "../images/zhejiangshenghuzhoushi.png?v=raw",
  "../images/zhejiangshengquzhoushi.png?v=raw"
];

const IMAGE_ASPECTS = new Array(IMAGE_SRCS.length).fill(1);
